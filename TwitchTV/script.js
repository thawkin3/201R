$(document).ready(function(){
	...
	var channels = ["TSM_Bjergsen", "freecodecamp", "TR7K", "ESL_SC2", "OgamingSC2", "cretetion", "storbeck", "terakilobyte", "habathcx", "RobotCaleb", "thomasballinger", "noobs2ninjas", "beohoff", "brunofin", "comster404"];
			...
			if (data.stream != null) {
				...
				$("tbody").prepend(
					"<tr class='normal'>" + 
						...
						"<td><a target='_blank' href='http://www.twitch.tv/" + display_name + "'>" + display_name + "</a></td>" + 
						"<td>" + game + ": " + status + "</td>" + 
					"</tr>"
				);
